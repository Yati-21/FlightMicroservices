...
public class UserServiceImplTest {
    ...
    void testGetByEmail_success() {
        ...
        Mockito.when(repo.findByEmail("jay@mail.com"))
                .thenReturn(Mono.just(user));

        StepVerifier.create(service.getByEmail("jay@mail.com"))
                .expectNext(user)
                .verifyComplete();
    }
    ...
    void testGetByEmail_notFound() {
        Mockito.when(repo.findByEmail("x@mail.com"))
                .thenReturn(Mono.empty());

        StepVerifier.create(service.getByEmail("x@mail.com"))
                .expectError(NotFoundException.class)
                .verify();
    }
    ...
    void testUpdateUser_success() {
        ...
        StepVerifier.create(service.updateUser("1", req))
                .expectNext(updated)
                .verifyComplete();
    }
    ...
    void testDeleteUser_success() {
        ...
        StepVerifier.create(service.deleteUser("1"))
                .verifyComplete();
    }
